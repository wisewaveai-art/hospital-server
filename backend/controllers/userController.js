...
exports.updateUserRole = async (req, res) => {
    try {
        ...
        const validRoles = ['admin', 'subadmin', 'doctor', 'staff', 'patient', 'vendor', 'nurse', 'pharmacy', 'ambulance', 'hr', 'head_nurse', 'lab', 'reception'];
        ...
        } else if (['staff', 'nurse', 'pharmacy', 'ambulance', 'hr', 'head_nurse', 'lab', 'reception'].includes(role)) {
